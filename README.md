...
> [!NOTE]
> Since Point and click tools are not allowed in the challenge Airflow webserver is not invoked in this project but to do so

Add the follow to ***docker-compose.yml***
```
  airflow-webserver:
    <<: *meltano-image
